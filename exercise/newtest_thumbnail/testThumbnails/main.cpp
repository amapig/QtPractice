...
int main(int argc, char *argv[])
{
    ...
    // FillMediaList("/home/skytree/Pictures", playQueue);
    //FillMediaList("/home/skytree/Videos", playQueue);
    playQueue->setCurrentIndex(0);

    viewer.rootContext()->setContextProperty("playQueue", playQueue);
    viewer.setMainQmlFile(QStringLiteral("qml/testThumbnails/testVideoThumbnail.qml"));
    // viewer.setMainQmlFile(QStringLiteral("qml/testThumbnails/main.qml"));
    viewer.showExpanded();
