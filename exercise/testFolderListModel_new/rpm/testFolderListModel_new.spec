...
%define _dprefix /altdata

Name:       testFolderListModel_new
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}%{_dprefix}/system/applications
...
#mkdir -p %{buildroot}%{_dprefix}/system/mime/packages
#cp -a %{SOURCE3} %{buildroot}%{_dprefix}/system/mime/packages

desktop-file-install --delete-original --dir %{buildroot}%{_dprefix}/system/applications %{buildroot}%{_dprefix}/system/applications/*.desktop
